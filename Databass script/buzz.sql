...
CREATE TABLE schedule (
    ...
    schedule_car_id int NOT NULL REFERENCES car(car_id),
    schedule_start_stop_station_id varchar(6) REFERENCES districts(id),
    schedule_end_stop_station_id varchar(6) REFERENCES districts(id),
    schedule_employee_driver_id int REFERENCES employee(employee_id)
);
CREATE TABLE ticket (
